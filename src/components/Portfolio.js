                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div data-spy="scroll" className='pre-scrollable' data-target="#myScrollspy" data-offset="10">
                                ...
                                <p className='mb-0'>-<span className='text-danger'> Dasboard:</span> I have gotten data from API and have displayed revenues by charts and statistic of loyal customer.</p>
                                ...
                                <p className='mb-0'>-<span className='text-danger'> Category:</span> Displayed all categories of website from API, client also can active or deactive one category. It will show up or disappear on user page. Besides, client can add new or edit any categoríe they want</p>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div data-spy="scroll" className='pre-scrollable' data-target="#myScrollspy" data-offset="10">
                                ...
                                <p className='mb-0'>-<span className='text-danger'> Customer:</span>  Display all customer by datatable. Client also see user's bidding histories and all payment histories</p>
                                <p className='mb-0'>-<span className='text-danger'> Feedback:</span>  Each card for one product, you can click on comment to show all comments of that product.</p>
                                <p className='mb-0'>-<span className='text-danger'> Product:</span> Displayed all products of website from API, client can also active or deactive one product. It will show up or disappear on user page. Besides, client can add new or edit any products they want</p>
                                <p className='mb-0'>-<span className='text-danger'> Doctor:</span> Displayed all doctors of website from API. Besides, client can add new doctors</p>
                                <p className='mb-0'>-<span className='text-danger'> Post:</span> Client can add new post about heathing of website. Besides, client can add new or edit any post want</p>
